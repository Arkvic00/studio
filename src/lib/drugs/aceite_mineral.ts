...
export const aceiteMineralDrug: Drug = {
  ...
  seguridad_y_alertas: {
    contraindicaciones: [
      "Vómitos activos, disfagia, megaesófago o riesgo de aspiración.",
      "Sospecha de obstrucción o perforación GI."
    ],
    efectos_adversos: [
      "Neumonía lipídica por aspiración (grave y fatal).",
    ...
    interacciones_farmacologicas: [{
      ...
      efecto: "Puede disminuir la absorción de vitaminas (A, D, E, K).",
      severidad: "Leve"
    }]
  },
  farmacologia_clinica: {
    ...
    farmacocinetica: "Mínima absorción sistémica si se administra oralmente."
  },
