...
import { Zap, AlertOctagon, Shield, Calculator, FileText, Bot } from 'lucide-react';
import { PinterestCard } from '@/components/ui/pinterest-card';
import { Badge } from '@/components/ui/badge';
import { getSpeciesInfo } from '@/lib/config';
import type { Drug } from '@/lib/types';
import { AIAssistantSummary } from '@/components/vademecum/ai-assistant-summary';
  ...
  return (
    <div className="max-w-7xl mx-auto animate-in fade-in duration-500">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <PinterestCard className="relative overflow-hidden border-l-8 border-l-accent">
                      <div className="relative z-10 flex flex-col md:flex-row items-start justify-between gap-8">
                          <div>
                           ...
                           <Button onClick={() => setShowAIAssistant(!showAIAssistant)} variant="ghost" size="lg" className="bg-primary/10 hover:bg-primary/20 text-primary">
                                <Bot size={20} className="mr-2"/>
                                {showAIAssistant ? 'Ocultar Asistente IA' : 'Resumen con IA'}
                            </Button>
                      </div>
                  </PinterestCard>
              </div>
            ...
            {showAIAssistant && (
                <div className="lg:col-span-12">
                    <AIAssistantSummary drug={drug} patientSpecies={patient.especie} />
                </div>
            )}
              ...
              <div className="lg:col-span-12 mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-6">
                        <PinterestCard>
                            <h3 className="text-sm font-black text-accent uppercase tracking-widest mb-4 flex items-center gap-2"><Zap size={16}/> Farmacología</h3>
                        ...
                        <PinterestCard>
                            <h3 className="text-sm font-black text-pink-400 uppercase tracking-widest mb-4 flex items-center gap-2"><AlertOctagon size={16}/> Sobredosis</h3>
                    ...
                    <div className="space-y-6">
                        <PinterestCard>
                            <h3 className="text-sm font-black text-orange-400 uppercase tracking-widest mb-4 flex items-center gap-2"><AlertOctagon size={16}/> Precauciones y Adversos</h3>
                            <div className="mb-4">
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 p-6 rounded-4xl">
                            <h3 className="text-sm font-black text-blue-400 uppercase tracking-widest mb-4 flex items-center gap-2"><Shield size={16}/> Reproducción</h3>
                        ...
                        <PinterestCard><h3 className="text-sm font-black text-yellow-400 uppercase tracking-widest mb-4 flex items-center gap-2"><AlertOctagon size={16}/> Interacciones</h3>
              ...
              <div className="lg:col-span-12">
                  <PinterestCard>
                      <h3 className="text-lg font-black text-white mb-4 flex items-center gap-2"><FileText size={16} /> Información para el Cliente</h3>
