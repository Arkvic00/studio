        ...
        {activeTab === 'clinical' ? (
            <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  <div className="bg-card p-6 rounded-4xl text-center border border-border"><p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Costo por mL</p><p className="text-2xl sm:text-3xl font-extrabold text-white">${clinicalRes.unit}</p></div>
                  <div className="bg-card p-6 rounded-4xl text-center border border-border"><p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Costo Total</p><p className="text-2xl sm:text-3xl font-extrabold text-white">${clinicalRes.total}</p></div>
                  <div className="bg-green-600 p-8 rounded-4xl text-center shadow-lg shadow-green-900/20"><p className="text-[10px] font-bold text-green-200 uppercase tracking-wider mb-2">Precio al Público</p><p className="text-4xl sm:text-5xl font-extrabold text-white">${clinicalRes.publicPrice}</p></div>
                </div>
            </div>
        ) : (
            <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-2 gap-6 mt-8"><div className="bg-card p-8 rounded-4xl text-center border border-border"><p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Costo Diario</p><p className="text-3xl sm:text-4xl font-extrabold text-white">${dailyRes.daily}</p></div><div className="bg-emerald-600 p-8 rounded-4xl text-center shadow-lg shadow-emerald-900/20"><p className="text-[10px] font-bold text-emerald-200 uppercase tracking-wider mb-2">Costo Mensual</p><p className="text-4xl sm:text-5xl font-extrabold text-white">${dailyRes.monthly}</p></div></div>
            </div>
        )}
    </PinterestCard>
    </div>
